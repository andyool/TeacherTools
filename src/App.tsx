...
type TimerAlertPreferences = Pick<
  AppSettings,
  'timerChimeEnabled' | 'timerSpeechVoice' | 'timerVoiceEnabled'
>;
...
const TIMER_BROWSER_VOICE_CANDIDATES: Record<TimerSpeechVoice, string[]> = {
...
function getPreferredBrowserTimerVoice(voice: TimerSpeechVoice) {
...
function speakTimerAlertWithBrowserVoice(
  message: string,
...
function triggerTimerAlert(
  ...
  window.setTimeout(
    () => speakTimerAlert(kind, alertPreferences.timerSpeechVoice, alertRemainingMs),
    speechDelayMs
  );
}
